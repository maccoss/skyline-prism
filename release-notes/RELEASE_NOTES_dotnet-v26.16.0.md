# Skyline-PRISM (C#) dotnet-v26.16.0 Release Notes

The QC report now says what produced it and stops failing runs over an ordinary difference between the
control groups; the Spectrum density tab is DIA-only; and the retired Python engine is gone from the
repository.
