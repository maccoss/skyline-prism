# Skyline-PRISM (C#) dotnet-v26.18.0 Release Notes

Re-running to change one setting no longer recomputes everything, the Spectrum density tab says which
rollup produced its numbers, and a CSV export superseded by a parquet one is cleaned up.
