# Skyline-PRISM (C#) dotnet-v26.15.0

Batch correction is applied once per reporting arm instead of twice, and residuals gain a
batch-corrected form. **Protein quantities change** as a result - by a median of 2.7% - and the change
is an improvement, measured against held-out control injections rather than asserted. Peptide
quantities are bit-identical.
